...
do
	...
	do
		...
		model_path_rank=svm_rank_model_sampled_new/${mycase}.model
		pred_path_rank=svm_rank_pred_sampled_new/${mycase}.pred
		log_path_rank=svm_rank_log_sampled_new/${mycase}.log

		model_path_light=svm_light_model_sampled_new/${mycase}.model
		pred_path_light=svm_light_pred_sampled_new/${mycase}.pred
		log_path_light=svm_light_log_sampled_new/${mycase}.log

		job_path_rank=jobs_sampled_new/${mycase}_rank.job
		job_path_light=jobs_sampled_new/${mycase}_light.job
