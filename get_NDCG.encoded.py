...
if __name__ == "__main__":
    ...
    for rank_function in range(2):  # svm_rank:0 or svm_light:1
        ...
        if rank_function == 0:
            ...
            output_path = 'NDCG_result/svm_rank_encoded.result'

        else:
            print 'for svm light \n'
            output_path = 'NDCG_result/svm_light_encoded.result'
        ...
        # for each assay in the assay list
            ...
            for fold_id in range(5):
                ...
                test_path = 'testdata_encoded/' + mycase + '.test'

                if rank_function == 0:
                    pred_path = 'svm_rank_pred_encoded/' + mycase + '.pred'

                else:
                    pred_path = 'svm_light_pred_encoded/' + mycase + '.pred'
