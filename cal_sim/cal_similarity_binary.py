...
def get_sim(matrix_x, cid_list):
    ...
    for i in range(num_items):
        for j in range(i+1, num_items):
            ...
            #sim = 1 - spatial.distance.cosine(matrix_x[i], matrix_x[j])
...
if __name__ == '__main__':
    ...
    f_summary_result = open('summary_binary.result' ,'w')
    ...
    #for line in [1]:
        ...
        f_result_all = open('sim_result/'+assayname+'all_binary.txt', 'w')
        ...
        plt.savefig('sim_result/' + assayname + 'hist_binary.png')
        plt.close()
