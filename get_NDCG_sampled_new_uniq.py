...
if __name__ == "__main__":
    ...
    for rank_function in range(2):  # svm_rank:0 or svm_light:1
        ...
        if rank_function == 0:
            ...
            output_path = 'NDCG_result/svm_rank_sampled_733_0_0.02_uniq.result'

        else:
            print 'for svm light \n'
            output_path = 'NDCG_result/svm_light_sampled_733_0_0.02_uniq.result'


        ndcg_result = open(output_path, 'w')

        print 'test'
        #print >> ndcg_result,'assayname NDCG_k avg variance length sampling_rate'
        ...
        for encoding_rate in [0.02]: 
            ...
            mycasemore = mycase + '_pct_' + str(encoding_rate)+'_epochs_100_uniq' 
            ...
            '''
            print >> ndcg_result, assayname + ' ' + str(rank_length)+ ' 5 ' + str(avg_ndcg5) + ' ' + str(var_ndcg5) + ' ' + str(sampling_rate)
            print >> ndcg_result, assayname + ' ' + str(rank_length)+ ' 10 ' + str(avg_ndcg10) + ' ' + str(var_ndcg10) + ' ' + str(sampling_rate)
            print >> ndcg_result, assayname + ' ' + str(rank_length)+ ' all ' + str(avg_ndcgall) + ' ' + str(var_ndcgall) + ' ' + str(sampling_rate)
            '''
